    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_currency', models.CharField(max_length=3, validators=[django.core.validators.RegexValidator(message='کد ارز باید شامل سه حرف بزرگ باشد (مانند USD یا IRR).', regex='^[A-Z]{3}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'مالک'), ('admin', 'مدیر'), ('accountant', 'حسابدار'), ('viewer', 'مشاهده\u200cگر')], default='accountant', max_length=20)),
